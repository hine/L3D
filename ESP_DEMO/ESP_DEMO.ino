...
#define NUMPIXELS      512 //defines the number of pixels in the strip
...
int brightness = 45; //sets the default brightness value
...
void handle_color()
{
  String color1 = server.arg(0);//sets the color1 string to the value in argument 0
#if defined DEBUG
